...
<body>
	<%
		...
		try {
			...
			String sqlCount = "SELECT COUNT(*) FROM project_tb";
			...
			int sort = 1;
			String sqlSort = "SELECT ID from project_tb order by ref desc, step asc";
			rs = stmt.executeQuery(sqlSort);

			while (rs.next()) {
				int stepNum = rs.getInt(1);
				sql = "UPDATE project_tb SET STEP2=" + sort + " where ID=" + stepNum;
			...
			String sqlList = "SELECT ID, USERNAME, TITLE, TIME, HIT, INDENT from project_tb where STEP2 >=" + start
